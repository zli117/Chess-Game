...
public class VectorTest {
  ...
  public static class TestSameDirection {
    ...
    public void testSameDirection() {
      ...
      assertTrue(vector3.checkSameDirection(vector3));
      assertTrue(vector1.checkSameDirection(vector2));
      assertTrue(vector2.checkSameDirection(vector1));
      assertFalse(vector1.checkSameDirection(vector3));
      assertFalse(vector3.checkSameDirection(vector1));
      assertFalse(vector3.checkSameDirection(vector2));
    }
